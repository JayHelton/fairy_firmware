...
pub type R = crate::generics::R<u32, super::DETECTMODE>;
#[doc = "Writer for register DETECTMODE"]
pub type W = crate::generics::W<u32, super::DETECTMODE>;
#[doc = "Register DETECTMODE `reset()`'s with value 0"]
impl ResetValue for super::DETECTMODE {
    type Type = u32;
    #[inline(always)]
...
pub type DETECTMODE_R = crate::generics::R<bool, DETECTMODE_A>;
impl DETECTMODE_R {
