use crate::generics::{ResetValue, Variant};

#[doc = "Reader of register PIN_CNF[%s]"]
pub type R = crate::generics::R<u32, super::PIN_CNF>;
#[doc = "Writer for register PIN_CNF[%s]"]
pub type W = crate::generics::W<u32, super::PIN_CNF>;
#[doc = "Register PIN_CNF[%s]
`reset()`'s with value 0x02"]
impl ResetValue for super::PIN_CNF {
    type Type = u32;
    #[inline(always)]
...
pub type DIR_R = crate::generics::R<bool, DIR_A>;
impl DIR_R {
...
pub type INPUT_R = crate::generics::R<bool, INPUT_A>;
impl INPUT_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
pub type PULL_R = crate::generics::R<u8, PULL_A>;
impl PULL_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
pub type DRIVE_R = crate::generics::R<u8, DRIVE_A>;
impl DRIVE_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
pub type SENSE_R = crate::generics::R<u8, SENSE_A>;
impl SENSE_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
